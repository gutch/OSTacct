# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in ostacct.
...
from ostacct.lib import app_globals, helpers 
...
base_config.model = ostacct.model
base_config.DBSession = ostacct.model.DBSession
